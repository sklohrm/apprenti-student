...
class MemoryServiceIntegrationTest {
    ...
    void shouldUpdate() throws DataAccessException {
        ...
        Memory existingMemory = service.findMemoryById(11);
        ...
        Memory updatedMemory = service.findMemoryById(11);
