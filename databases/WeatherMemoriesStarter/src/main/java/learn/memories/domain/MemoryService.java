...
public class MemoryService {
    ...
    public MemoryService(MemoryRepository repository, WeatherService weatherService){
        this.repository = repository;
        this.weatherService  = weatherService;
    }

    public Memory findMemoryById(int id) throws DataAccessException{
    ...
    public MemoryResult add(Memory memory) throws DataAccessException {
        ...
        if(result.isSuccess()) {
            ...
            memory.setAverageTemp(weatherService.getAverageTemperaturesForDate(start,end));
